...
export const TOOL_DISPATCH_BROWSER_TASK = {
  ...
  DESCRIPTION: 'Dispatch a browser task to Worker subagent for execution.',
  PARAMS: {
    TASK: 'Self-contained task description for Worker',
    STOP_CONDITION: 'When Worker should stop and return results',
